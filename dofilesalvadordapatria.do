...
import excel "C:\Users\Matheus\Desktop\pedidosai\respostapedidopopulacao\Recurso Demografico 2010-2019.xlsx", sheet("MUNICIPIO") firstrow allstring clear
...
collapse (sum) mort_totais suicidio agressao resp saneamento prev infantil prevum prevdois prevtres parto menosde5 acomat, by(DSEI ano)
rename * *dsei
...
foreach i in mort_totais suicidio agressao resp saneamento prev prevum prevdois prevtres infantil parto menosde5 acomat{
...
*abrindo a base
use "C:\Users\Matheus\Desktop\politica.dta", clear
